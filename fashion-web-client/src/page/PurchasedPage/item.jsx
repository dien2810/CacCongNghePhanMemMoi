  ...
  return (
    <div className="container-1056 cart-item">
      ...
      >
        ...
        <div className="id-item" style={{ width: "14.802%", color: "black" }}>
          {formatCash(priceAfterDiscount)}đ
        </div>
        <div className="container-item" style={{ width: "12.203%" }}>
          <div className="quatity-item" style={{ width: "100%" }}>
            {item.quantity}
          </div>
        </div>
        <div
      ...
      <div className="container-item container-padding shipment">
        ...
        >
          ...
          <div className="shipment-price">
            {item.shipFee ? formatCash(item.shipFee) : formatCash(0)}
          </div>
        </div>
      </div>
      <div className="container-item container-padding item-price-cart">
        ...
        <div className="itemprice-amount">
          {item.shipFee
            ? formatCash(item.quantity * priceAfterDiscount + item.shipFee)
            : formatCash(item.quantity * priceAfterDiscount)}
          đ
        </div>
      </div>
    </div>
