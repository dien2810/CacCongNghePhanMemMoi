...
// 			setTimeout(() => {
// 				// Bạn có thể điều chỉnh reject() để thử nghiệm ErrorPopup
// 				resolve({ success: true });
// 			}, 1000);
// 		});
// 	},
// 	getCartByUsername: (username) => {
// 		// Giả lập dữ liệu giỏ hàng sau 1 giây
// 		return new Promise((resolve) => {
// 			setTimeout(() => {
// 				const mockCartData = [
// 					{ id: 1, name: 'Sản phẩm 1', price: 50000, quantity: 2, discount: 0.1, shipFee: 10000 },
// 					{ id: 2, name: 'Sản phẩm 2', price: 30000, quantity: 1, discount: 0.05, shipFee: 8000 },
// 				];
