  ...
  return (
    <ul>
      <input
        ...
        defaultChecked={true}
      />
      <input type="radio" name="options" id="history-menu-order" />
      <input type="radio" name="options" id="history-menu-notify" />
      <input type="radio" name="options" id="history-menu-logout" />
      <li className="history-menu-account">
        <FontAwesomeIcon className="history-menu-icon" icon={faUser} />
        <label
      ...
      <li className="history-menu-order">
        <FontAwesomeIcon className="history-menu-icon" icon={faCalendar} />
        <label
      ...
      <li className="history-menu-notify">
        <FontAwesomeIcon className="history-menu-icon" icon={faBell} />
        <label
      ...
      <li className="history-menu-logout">
        ...
        />
        <label htmlFor="history-menu-logout" onClick={() => logout()}>
          Logout
        </label>
      </li>
    </ul>
