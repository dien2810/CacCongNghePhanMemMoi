...
function OrderPopup() {
  ...
  const addItemToCart = async () => {
    ...
    if (!itemsInCart.some((itemInCart) => itemInCart.itemId === item._id)) {
      const data = {
      ...
      clientAPI
        ...
        .then(() => {
          ...
          //   cartApi.getCartByUsername(user.username)
          clientAPI.find({ username: user.username }).then((response) => {
            console.log("Response");
            console.log(response.data);
            dispatch(itemsSlice.actions.setUserItems(response.data));
            setOrderState({
              ...orderState,
              state: "success",
        ...
        <div className="box">
          ...
          <div className="boxes bx2">
            <div className="popup-col">
              <h1 className="popup-heading" style={{ marginBottom: 15 }}>
                ĐẶT HÀNG
              </h1>
              <div
              ...
              >
                ...
                <div className="popup-row discountprice popup-fontsize">
                  Đánh giá:
                  <Star rating={item.rating} style={{ margin: "0 0" }} />
                </div>
              </div>
              <div
                className="container-1139 card-content-container"
              ...
              >
                <div className="popup-row">
                  ...
                  <button className="uwywa" onClick={() => addItemToCart()}>
                    ĐẶT HÀNG
                  </button>
                </div>
              </div>
